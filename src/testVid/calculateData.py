...
for clid in range(3):
    ...
    ax[0].plot(recall[:-1], precision[:-1], label = clid, c = colors[clid])
...
ax[0].set(xlabel = "recall", ylabel = "precision", title = "Raw PR curve")
ax[1].set(xlabel = "recall", ylabel = "precision", title = "Interpolated PR curve")
