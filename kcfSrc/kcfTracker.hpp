...
namespace cv{
  ...
  public:
      ...
      */
      ...
      void track(const cv::Mat & img, double *maxResponse);
      BBox_c getBBox();
  ...
  private:
      ...
      void initO(cv::Mat & img, const cv::Rect & bbox);
      void initO(const cv::Mat & img, const cv::Rect & bbox);
...
#endif //KCF_HEADER_6565467831230
